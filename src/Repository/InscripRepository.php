...
/**
 * @extends ServiceEntityRepository<Inscrip>
 *
...
class InscripRepository extends ServiceEntityRepository
{
    ...
    public function save(Inscrip $entity, bool $flush = false): void
    {
    ...
    public function remove(Inscrip $entity, bool $flush = false): void
    {
